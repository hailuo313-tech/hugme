...
def test_asset_keyword_matches_spanish_photo_requests() -> None:
    assert _keyword_matches(
        "mándame fotos de tus partes",
        "fotos",
        asset_kind="image",
    )
    assert _keyword_matches(
        "mándame una foto tuya en escote",
        "foto",
        asset_kind="image",
    )
    assert _keyword_matches(
        "pues crea una imagen cachonda o envíame una",
        "imagen",
        asset_kind="image",
    )
