...
@pytest.mark.asyncio
async def test_history_from_redis_is_inserted_between_system_and_user(monkeypatch, llm_orchestrator):
...
@pytest.mark.asyncio
async def test_db_loaded_character_and_profile_appear_in_prompt(monkeypatch, llm_orchestrator):
