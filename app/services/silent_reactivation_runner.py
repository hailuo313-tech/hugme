    ...
    *,
    ...
    for row in candidates:
        ...
        try:
            ...
            log.bind(user_id=user_id, error_type=type(exc).__name__).warning("silent_reactivation.evaluate_failed")
        ...
        try:
            ...
            log.bind(user_id=user_id, error_type=type(exc).__name__).warning("silent_reactivation.insert_failed")
